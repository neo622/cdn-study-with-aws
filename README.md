...
## 과제 회고
---
항상 On-Premise 환경에서만 개발을 하다보니 AWS를 사용할 기회가 없었는데, 이번 기회에 자세히 알게 되어서 좋았습니다.
가이드라인이 잘 잡혀져 있어 따라가면서 개념에 대해 숙지하고 이해하기에 좋았습니다.
...
1. on-premise 환경에서 인프라성능을 높이기 위해 nginx를 도입하는 것은 옳은 선택일 수 있을까요?
